...
public class Language {
	...
	public enum Term {
		...
		CONFIGURE_LINK_ALREADY_CONFIGURED,
		CONFIGURE_LINK_SUCCESS,

		CONFIGURE_UNLINK_DESCRIPTION,
		CONFIGURE_UNLINK_NOT_LINKED,
		CONFIGURE_UNLINK_SUCCESS,

		CONFIGURE_TEST_DESCRIPTION,
		CONFIGURE_TEST_WORKING("time"),

		CONFIGURE_USERNAME_SYNC_DESCRIPTION,
		CONFIGURE_USERNAME_SYNC_OPTION_STATE,
		CONFIGURE_USERNAME_SYNC_MISSING_PERMISSION,
		CONFIGURE_USERNAME_SYNC_ENABLED,
		CONFIGURE_USERNAME_SYNC_DISABLED,

		CONFIGURE_UPDATE_USERNAMES_DESCRIPTION,
		CONFIGURE_UPDATE_USERNAMES_START,
		CONFIGURE_UPDATE_USERNAMES_DONE,
